...
/**
 *  CostEvent: Class represents the cost update event. It's used when
 *  propagate the cost in the RMTPG and specify the cost to achieve a
 *  given fact is update at a specific time.
 */
