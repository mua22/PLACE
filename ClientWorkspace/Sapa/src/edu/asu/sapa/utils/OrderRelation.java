...
/**
 * OrderRelation: Represent the relations between two actions.
 * It can be causal relation, mutex relations based on
 * confliction in using some predicate or metric resource 
 */
