...
/** To initialize this domain.
  ...
  */
  public void close(int varsMaxSize) throws IOException
  {
    ...
    BufferedWriter dest = new BufferedWriter(new FileWriter(path+name + ".java"));
    ...
    dest = new BufferedWriter(new FileWriter(path+name + ".txt"));
  ...
  */
  public void commandInitialize() throws IOException
  {
    ...
    //-- Open the file.
    src = new BufferedReader(new FileReader(path+name + ".txt"));
  ...
  */
              ...
              throws IOException
  {
    ...
    //-- Open the file with the appropriate name.
    dest = new BufferedWriter(new FileWriter(path+probName + ".java"));
