...
public class PlacePlanAction implements Comparable{
	 ...
	 */
	public FunctionSignature getActionCall() {
		return actionCall;
	}
	...
	public String toString() {
		...
		str+="Add: " + this.getAddEffectsCollection();
		str+="Remove: " + this.getDeleteEffectsCollection();
		return str; 
	}
	...
	/**
	 * @return
	 * @see epclaim.compiler.Capability#getName()
	 */
	 ...
	 * @param actionCall
	 * @return
	 * @see epclaim.compiler.Action#perform(epclaim.compiler.Agent, epclaim.compiler.FunctionSignature)
	 */
	public boolean perform(Agent agent, FunctionSignature actionCall) {
		return action.perform(agent, actionCall);
	}

	/**
	 * @param agent
	 * @return
	 * @see epclaim.compiler.Action#perform(epclaim.compiler.Agent)
	 */
